    ...
    <div class="site-section block-15">
        <div class="container">
            ...
            <div v-if="this.todasPromos.lenght !== 0" class="nonloop-block-15 owl-carousel">
                <div v-for="promosData in todasPromos" :key="promosData.key" class="media-with-text p-md-5">                     <router-link :to="{ name: 'reservas', params: { key: hotel.key, promo: promosData.key } }" >
