        ...
        <div class="site-section site-section-sm">
            ...
            <div class="row">
                ...
                <div class="p-4 mb-3 bg-white">
                    ...
                    <p  class="mb-4">Miraflores </p>
                    <p class="mb-0 font-weight-bold">Teléfono</p>
                    <p class="mb-4"><a href="#">+51 235 568 855</a></p>
                    <p class="mb-0 font-weight-bold">Correo Electrónico</p>
                    <p class="mb-0"><a href="#"><span class="__cf_email__" data-cfemail="0871677d7a6d65696164486c6765696166266b6765">hotel@hotel.com</span></a></p>
                </div>
                </div>
            </div>
            </div>
