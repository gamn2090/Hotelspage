        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 mb-5 mb-md-0">
                    <div class="img-border">
                        <a target="_blank" href="https://www.youtube.com/watch?v=FsfrsLxt0l8" class="popup-vimeo image-play">
                            ...
                            <img src="assets/images/img_2.jpg" alt="video image" class="img-fluid">
                        </a>
                    </div>                    
                </div>
                <div class="col-md-5 ml-auto">
                    ...
                    <p><a target="_blank" href="https://www.youtube.com/watch?v=FsfrsLxt0l8" class="popup-vimeo text-uppercase">Ver video <span class="icon-arrow-right small"></span></a></p>
                </div>
            </div>
        </div>
    </div>
